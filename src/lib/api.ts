...
export const api = {
  ...
  endpoints: {
    ...
    agents: {
      ...
      generateTestCasesFromArchetypes: (id: string) => `${API_BASE_URL}/api/agents/${id}/generate-test-cases-from-archetypes`,
      listArchetypes: (id: string) => `${API_BASE_URL}/api/agents/${id}/test-archetypes`,
