  ...
  return (
    ...
    >
      <Container className="flex items-center justify-between h-[72px]">
        <Link
          href="/"
          className="group flex items-center gap-3 text-[#EEEEEE] font-medium text-lg z-50"
        >
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="hidden md:flex items-center gap-5">
            <Link
              href="/sign-in"
              className="text-[15px] font-medium text-[#8A8F98] hover:text-[#EEEEEE] transition-colors"
            >
              Sign in
            </Link>
            <Link href="/sign-up">
              <Button
                size="sm"
                className="h-9 px-5 text-[14px] font-medium bg-[#5E6AD2] text-white hover:bg-[#5E6AD2]/90 transition-all duration-300 hover:shadow-[0_0_15px_-3px_rgba(94,106,210,0.4)] hover:scale-105"
              >
                Get started
              </Button>
            </Link>
            ...
            >
              ...
              >
                <Link
                  href="/sign-in"
                  onClick={() => setIsOpen(false)}
                  className="text-center py-3 font-medium text-[#8A8F98] hover:text-[#EEEEEE] transition-colors"
                >
                  Sign in
                </Link>
